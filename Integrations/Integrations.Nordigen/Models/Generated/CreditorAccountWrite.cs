...
namespace Integrations.Nordigen.Models
{
    ...
    /// </summary>
    [DataContract(Name = "CreditorAccountWrite")]
    public partial class CreditorAccountWrite : IEquatable<CreditorAccountWrite>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditorAccountWrite" /> class.
        /// </summary>
        [JsonConstructor]
        protected CreditorAccountWrite() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditorAccountWrite" /> class.
        /// </summary>
        ...
        public CreditorAccountWrite(string name = default(string), TypeEnum? type = default(TypeEnum?), string account = default(string), string currency = default(string), AddressCountryEnum? addressCountry = default(AddressCountryEnum?), string institutionId = default(string), string agent = default(string), string agentName = default(string), string addressStreet = default(string), string postCode = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreditorAccountWrite and cannot be null");
            }
            this.Name = name;
            // to ensure "account" is required (not null)
            if (account == null)
            {
                throw new ArgumentNullException("account is a required property for CreditorAccountWrite and cannot be null");
            }
            this.Account = account;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for CreditorAccountWrite and cannot be null");
            }
        ...
        {
            return this.Equals(input as CreditorAccountWrite);
        }

        /// <summary>
        /// Returns true if CreditorAccountWrite instances are equal
        /// </summary>
        /// <param name="input">Instance of CreditorAccountWrite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreditorAccountWrite input)
        {
            if (input == null)
            {
                return false;
