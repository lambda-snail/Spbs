...
namespace Integrations.Nordigen.Models
{
    ...
    /// </summary>
    [DataContract(Name = "DebtorAccountWriteRequest")]
    public partial class DebtorAccountWriteRequest : IEquatable<DebtorAccountWriteRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtorAccountWriteRequest" /> class.
        /// </summary>
        [JsonConstructor]
        protected DebtorAccountWriteRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DebtorAccountWriteRequest" /> class.
        /// </summary>
        ...
        public DebtorAccountWriteRequest(string currency = default(string), string typeNumber = default(string), TypeEnum? type = default(TypeEnum?), string name = default(string), string addressCountry = default(string), string postCode = default(string), string addressStreet = default(string))
        {
            // to ensure "typeNumber" is required (not null)
            if (typeNumber == null)
            {
                throw new ArgumentNullException("typeNumber is a required property for DebtorAccountWriteRequest and cannot be null");
            }
            this.TypeNumber = typeNumber;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DebtorAccountWriteRequest and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as DebtorAccountWriteRequest);
        }

        /// <summary>
        /// Returns true if DebtorAccountWriteRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtorAccountWriteRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtorAccountWriteRequest input)
        {
            if (input == null)
            {
                return false;
