...
namespace Integrations.Nordigen.Models
{
    ...
    public partial class PeriodicPayment : IEquatable<PeriodicPayment>, IValidatableObject
    {
        ...
        public PeriodicPayment(FrequencyEnum? frequency = default(FrequencyEnum?), DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), ExecutionRuleEnum? executionRule = default(ExecutionRuleEnum?), string dayOfExecution = default(string))
        {
