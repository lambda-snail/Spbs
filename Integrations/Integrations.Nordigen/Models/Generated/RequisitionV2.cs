...
namespace Integrations.Nordigen.Models
{
    ...
    public partial class RequisitionV2 : IValidatableObject
    {
        ...
        public RequisitionV2(string redirect = default(string), string institutionId = default(string), Guid agreement = default(Guid), string reference = default(string), string userLanguage = default(string), string ssn = default(string), bool accountSelection = false, bool redirectImmediate = false)
        {
