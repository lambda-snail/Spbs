...
public class ExpenseCategories
{
    ...
    public static readonly Category DiningOut = new() { Name = "DiningOut", MudIcon = Icons.Material.Filled.Fastfood };
    ...
    public static readonly Category DebtPayment = new() { Name = "DebtPayment", MudIcon = Icons.Material.Filled.MonetizationOn };
    public static readonly Category PersonalSpending = new() { Name = "PersonalSpending", MudIcon = Icons.Material.Filled.SelfImprovement };
